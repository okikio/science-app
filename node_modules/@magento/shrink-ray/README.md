...
**This is a fork of [shrink-ray-current](https://www.npmjs.com/package/shrink-ray-current) maintained for [Magento PWA Studio](https://github.com/magento-research/pwa-studio) until `shrink-ray-current` chooses to merge https://github.com/Alorel/shrink-ray/pull/36.**
...
[![Version](https://img.shields.io/npm/v/@magento/shrink-ray.svg?style=flat-square)](https://www.npmjs.com/package/@magento/shrink-ray)
[![License](https://img.shields.io/npm/l/@magento/shrink-ray.svg?style=flat-square)](https://www.npmjs.com/package/@magento/shrink-ray)
[![Build status](https://img.shields.io/travis/magento-research/shrink-ray/3.0.2.svg?style=flat-square)](https://travis-ci.org/magento-research/shrink-ray)
[![Coverage](https://img.shields.io/coveralls/github/magento-research/shrink-ray/3.0.2.svg?style=flat-square)](https://coveralls.io/github/magento-research/shrink-ray)
[![Dependencies](https://img.shields.io/david/magento-research/shrink-ray.svg?style=flat-square)](https://github.com/magento-research/shrink-ray/blob/master/package.json)
...
In addition, if a response contains an ETag, `@magento/shrink-ray` will cache the compressed
...
```bash
npm install @magento/shrink-ray
```
...
```js
const shrinkRay = require('@magento/shrink-ray');
```
